...
<p align="center">
  ...
  <a href="#中文">中文 / 简体中文</a>
  &nbsp;·&nbsp;
  <a href="https://github.com/Stargod-0812/starline/issues">Issues</a>
  &nbsp;·&nbsp;
  <a href="#faq">FAQ</a>
</p>
...
```bash
brew install Stargod-0812/tap/starline
starline install
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Stargod-0812/starline/main/install.sh | bash
```
...
```bash
git clone https://github.com/Stargod-0812/starline ~/.local/share/starline
...
```bash
git clone https://github.com/Stargod-0812/starline
cd starline
./bin/starline doctor
node --test test/*.mjs
```
